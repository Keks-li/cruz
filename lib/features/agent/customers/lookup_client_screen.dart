                    ...
                    return Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: boxesRemaining > 0 ? () async {
                              final productRepo = ref.read(productRepositoryProvider);
                              final product = await productRepo.getProductById(customer.productId);
                              if (product != null && context.mounted) {
                                _showCollectDialog(
                                  customer.id,
                                  customer.fullName,
                                  customer.productName ?? 'Unknown',
                                  customer.balanceDue,
                                  product.boxRate,
